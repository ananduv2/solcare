...
function(e) {
    ...
    jQuery.extend(!0, t, {
        ...
        organiseCarousel: function(e, i, a, r, o) {
            ...
            for (var g = 0; g < s.len; g++) !0 === s.justify ? (p += g > 0 ? s.slide_widths[g - 1] + s.space : s.slide_offset, s.wrapwidth >= s.maxwidth && "center" !== s.horizontal_align && (s.slideFakePositions[g] = p - s.slide_offset), d = 0 - s.slide_widths[g], l = s.maxwidth - s.slide_widths[g], s.inneroffset = 0) : (p = g * s.slide_width + s.slide_offset, s.wrapwidth >= s.maxwidth && "left" === s.horizontal_align && (s.slideFakePositions[g] = g * s.slide_width), s.wrapwidth >= s.maxwidth && "right" === s.horizontal_align && (s.slideFakePositions[g] = s.wrapwidth - (g + 1) * s.slide_width)), h = u = p, s.infinity && (u = u >= l - s.inneroffset ? u - s.maxwidth : u <= d - s.inneroffset ? u + s.maxwidth : u), s.slidepositions[g] = h > s.maxwidth + l ? u - s.maxwidth : h < d - s.maxwidth ? u + s.maxwidth : u;
            var f = 999,
                m = 0,
                v = (t[e].ulw, !1),
    ...
    var i = function(e, i) {
        ...
        r = function(e) {
            ...
            if (void 0 === i.wrap && function(e) {
                    var i = t[e].carousel;
                    i.infbackup = i.infinity, i.maxVisiblebackup = i.maxVisibleItems, i.slide_offset = "none", i.slide_offset = 0, i.wrap = t[e].c.find("rs-carousel-wrap"), 0 !== i.maxRotation && ("3D" !== t[e].parallax.type && "3d" !== t[e].parallax.type || punchgs.TweenLite.set(i.wrap, {
                        perspective: "1600px",
            ...
            if ("preset" !== e.mode || !0 === p.frames.frame_1.timeline.waitoncall || void 0 !== p.scrollBasedOffset || !0 === p.forceRender) {
                    ...
                    if (p.ford.hasOwnProperty(L)) {
                        ...
                        if ("frame_0" !== I && "frame_hover" !== I && "loop" !== I) {
                            ...
                            if ("frame_999" !== I || !1 !== w || "continue" !== e.mode && "start" !== e.mode && "rebuild" !== e.mode) {
                                p.fff = "frame_1" === I && ("trigger" !== e.mode || "frame_999" === p.currentframe || "frame_0" === p.currentframe || void 0 === p.currentframe), S || (p.frames[I].timeline.callstate = "called", p.currentframe = I);
                                var A = p.frames[I],
                ...
                if (S || (p.lastRequestedMainFrame = "start" === e.mode ? "frame_1" : "continue" === e.mode ? e.frame : p.lastRequestedMainFrame), void 0 !== e.totime ? p.tSTART = e.totime : void 0 !== u && void 0 === e.frame ? p.tSTART = u : void 0 !== e.frame ? p.tSTART = e.frame : p.tSTART = 0, 0 === p.tSTART && void 0 === p.startedAnimOnce && void 0 === p.leftstage && void 0 === p.startedAnimOnce && !0 === p.hideonfirststart && "preset" === e.mode && (i[d]._L[a[0].id].p[0].classList.add("rs-forcehidden"), p.hideonfirststart = !1), "frame_999" !== p.tSTART && "frame_999" !== p.triggeredFrame || !p.leftstage && void 0 !== p.startedAnimOnce) {
                    if ("true" != p.animationonscroll && 1 != p.animationonscroll ? p.timeline.play(p.tSTART) : p.timeline.time(p.tSTART), jQuery.inArray(p.type, ["group", "row", "column"]) >= 0 && void 0 !== e.frame) {
                        ...
                        var pe = void 0 === e.totime ? void 0 !== p.frames[e.frame].timeline.startAbsolute ? parseInt(p.frames[e.frame].timeline.startAbsolute, 0) / 1e3 : void 0 !== p.frames[e.frame].timeline.start ? jQuery.isNumeric(p.frames[e.frame].timeline.start) ? parseInt(p.frames[e.frame].timeline.start, 0) / 1e3 : e.totime : .001 : e.totime;
...
function(e) {
    ...
    jQuery.extend(!0, t, {
        ...
        createNavigation: function(e) {
            ...
            }), c(o), c(l), c(f), c(v), t[e].cpar.on("click", function(a) {
        ...
        a = function(e) {
            ...
            if (0 == d) {
                ...
                t[a].slots -= t[a].slots % 2 == 1 ? 1 : 0, t[a].pr_active_bg.find(".slotslide").each(function(e) {
                    ...
                    I.add(punchgs.TweenLite.to(this, S, {
                        transformPerspective: 600,
                        force3D: "auto",
                        ...
                        rotation: t[a].rotate,
                        ease: g,
                        delay: (5 !== d ? i : t[a].slots - i) * (S / t[a].slots) / (6 === d ? 1.3 : 1)
                    }), 0), t[a].mtl.add(I, 0)
                }), t[a].pr_next_bg.find(".slotslide").each(function(e) {
                    var i = 6 !== d ? e : e > t[a].slots / 2 ? t[a].slots - e : e;
                    I.add(punchgs.TweenLite.from(this, S, {
                        top: 1 == n ? t[a].height : -t[a].height,
                        opacity: .75,
                        rotation: t[a].rotate,
                        force3D: "auto",
                ...
                var A = t[a].pr_next_bg[0].getElementsByClassName("slotslide"),
                    R = p - p / 1.8;
                for (k = 0; k < A.length; k++) t[a].mtl.add(punchgs.TweenLite.fromTo(A[k], (p - k * (R / t[a].slots)) / 1e3, {
                    opacity: 0,
                    force3D: "auto",
                    transformPerspective: 600
                }, {
                ...
                var C = 3 == l.trC ? p / 1300 : p / 1e3,
                    ...
                    B = 4 == l.trC || 5 == l.trC ? .6 : 6 == l.trC ? 1.4 : 1,
                    W = 5 == l.trC ? 1.4 : 6 == l.trC ? .6 : 1;
                if (7 != l.trC && 4 != l.trC || (j = 0, H = 0), 8 == l.trC ? (t[a].mtl.add(punchgs.TweenLite.set(t[a].pr_active_slide, {
                        zIndex: 20
                ...
                F = 19 === d ? "center center -" + t[a].height / 2 : 22 === d ? "center center " + t[a].height / 2 : 23 === d ? "center center -" + t[a].width / 2 : "center center " + t[a].width / 2;
                ...
                F = 1 === n ? "20% " : "80% ";
                F += "60% -50%", t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_next_bg, p / 1e3, {
                    ...
                    delay: 0,
                    ease: g
                }), 0), F = 1 != n ? "20% " : "80% ", F += "60% -50%", t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_active_bg, p / 1e3, {
                    autoAlpha: 1,
                    rotationX: 0,
                    top: 0,
                    z: 0,
                ...
                F = 1 === n ? 25 === d ? "center top 0" : "left center 0" : 25 === d ? "center bottom 0" : "right center 0";
                t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_next_bg, p / 1e3, {
                    transformStyle: "flat",
                    rotationX: Y,
                    top: 0,
                    ...
                    rotationY: 0,
                    ease: g
                }), 0), F = 1 === n ? 25 === d ? "center bottom 0" : "right center 0" : 25 === d ? "center top 0" : "left center 0", E = 25 !== d ? -E : E, Y = 25 !== d ? Y : -Y, t[a].mtl.add(punchgs.TweenLite.fromTo(t[a].pr_active_bg, p / 1e3, {
                    rotationX: 0,
                    rotationY: 0,
                    transformStyle: "flat",
                    transformPerspective: 1200,
